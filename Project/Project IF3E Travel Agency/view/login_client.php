...
<head>
    ...
    <title>Login Client - Sheep's Travel</title>
    <!-- Lien vers le fichier CSS -->
    <link rel="stylesheet" href="../styles/login_client.css">
</head>
...
<div class="header">
    <h1 class="login-title">Login Client</h1>
</div>

<form method="post" action="../controller/login_client.php" id="loginForm">
    <label>
        Email :
    ...
    <a href="login_staff.php" class="toggle-button">Staff</a>
