...
<head>
    ...
    <title>Transportation - Sheep's Travel</title>
...
<section id="transport-section">
    ...
    <form id="booking-form" action="../controller/transport.php" method="POST">
        ...
        <label for="price" id="price">
            <p> Prix minimum : 50 € (valeur calculé après tentative de réservation)</p>
        </label>
